...
public class LibraryUsers {
    ...
    public void displayUsers() {
        System.out.println("The User in system");
        int index = 1;
        for (User user : users) {
            System.out.printf("%d. %s\n", index++, user);
        }
    ...
    public static void main(String[] args) {
        LibraryUsers mySystem = new LibraryUsers();
        ...
        while (true) {
            try {
                ...
                System.out.println("7. List of User");
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        user.setBorrowBooks(borrowTitle);
                        user.getBorrowbooks();
                        System.out.printf("Book %s added to User %s\n", borrowTitle, name);
                        break;
                    case 5:
                        ...
                        user.removeBorrowedBook(returnTitle);
                        user.getBorrowbooks();
                        System.out.printf("Book %s removed from User %s\n", returnTitle, name);
                        break;
                    case 6:
